package com.mshz.microfilemanager.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("microfilemanager");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("microfilemanager");
        ...
        config.getMapConfigs().put("com.mshz.microfilemanager.domain.*", initializeDomainMapConfig(jHipsterProperties));
